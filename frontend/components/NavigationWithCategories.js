...
const NavigationWithCategories = () => {
  ...
  const navLinks = [
    ...
    { name: 'Categories', href: '#categories', icon: null, hasMenu: true },
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await fetch('/api/categories/hierarchical/parents');
                      ...
                      <Box key={link.name} as="li">
                        {link.hasMenu ? (
                          <Button
                            ...
                            aria-expanded={Boolean(categoriesMenuAnchor)}
                            sx={{
        ...
        >
          ...
          <Box sx={{ flexGrow: 1, p: 2 }}>
            <List sx={{ pt: 2 }} component="ul">
              ...
              <ListItem disablePadding sx={{ mb: 1 }} component="li">
                <Typography
                  variant="subtitle1"
                  sx={{
                    color: '#ffd700',
